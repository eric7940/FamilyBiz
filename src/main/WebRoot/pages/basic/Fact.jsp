...
<title><bean:message key="all.func.basic.3"/></title>
...
<body>
<html:form action="fact" method="post" onsubmit="return false;">
<html:hidden property="state" value=""/>
<html:hidden property="factId" value=""/>
<bean:define id="form" name="FactForm"/>

<table cellspacing="0" cellpadding="0" border="0" width="100%" style="margin-top: 1px;">
<tr>
<td align="left" valign="top">
<H2 class="funcheader">功能：<bean:message key="all.func.basic.3"/></H2>
...
<tr>
<th>&nbsp;</th>
<th width="40"><bean:message key="all.column.fact.1"/></th>
<th width="170"><bean:message key="all.column.fact.2"/></th>
<th width="80"><bean:message key="all.column.fact.4"/></th>
<th width="80"><bean:message key="all.column.fact.5"/></th>
<th width="330"><bean:message key="all.column.fact.6"/></th>
<th width="100"><bean:message key="all.column.fact.7"/></th>
<th>&nbsp;</th>
</tr>
</thead>

<tbody>
<logic:iterate id="fact" name="form" property="facts" indexId="idx">
<tr>
<td><input type="checkbox" name="selectIdx" value='<%=idx.toString()%>'></td>
<td align="center"><bean:write name="fact" property="factId"/></td>
<td><bean:write name="fact" property="factNme"/></td>
<td><bean:write name="fact" property="contact"/></td>
<td><bean:write name="fact" property="tel"/></td>
<td><bean:write name="fact" property="addr"/></td>
<td><bean:write name="fact" property="memo"/></td>
<td><input type="button" value='<bean:message key="all.btn.3"/>' onclick="modify(this.form, '<bean:write name="fact" property="factId"/>')"/></td>
</tr>
</logic:iterate>
</tbody>
</table>
...
$(function () {
	...
	$("#filter").keyup(function() {
		$.uiTableFilter($("#tb"), this.value, '<bean:message key="all.column.fact.2"/>');
	});
